...
function SignUp() {
    ...
    return (
        <div className='montserrat-alternates font-semibold h-screen grid justify-center items-center md:text-xl'>

            <div className='w-[300px] md:w-[700px]'>

                <p className="text-3xl font-bold my-10 md:pl-10">Sign Up Here</p>
                ...
                <form onSubmit={handleSubmit(handleSignUp)}>
                    ...
                    <div className="flex justify-center mx-4 my-5 mb-lg-4">
                        <button className='type-4 btn-selection'> Sign Up </button>
                    </div>
                </form>
